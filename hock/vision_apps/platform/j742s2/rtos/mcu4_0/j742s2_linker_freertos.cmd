...
SECTIONS
{
    ...
    .text               : {} palign(8)      > DDR_MCU4_0
    .const              : {} palign(8)      > DDR_MCU4_0
    .rodata             : {} palign(8)      > DDR_MCU4_0
    .mpu_cfg                                > DDR_MCU4_0
    ...
    .stack              : {} align(4)       > DDR_MCU4_0
    .bss.devgroup     : {*(.bss.devgroup*)} align(4)       > DDR_MCU4_0
    .bss:taskStackSection > DDR_MCU4_0

    .data_buffer        : {} palign(128)    > DDR_MCU4_0
    .const.devgroup     : {*(.const.devgroup*)} align(4)       > DDR_MCU4_0
    .boardcfg_data      : {} align(4)       > DDR_MCU4_0

    .resource_table          :
    {
        __RESOURCE_TABLE = .;
    }                                           > DDR_MCU4_0_RESOURCE_TABLE
    ...
    .fiqStack   : {. = . + __FIQ_STACK_SIZE;} align(4)      > DDR_MCU4_0  (HIGH)
    RUN_START(__FIQ_STACK_START)
    RUN_END(__FIQ_STACK_END)

    .abortStack : {. = . + __ABORT_STACK_SIZE;} align(4)    > DDR_MCU4_0  (HIGH)
    RUN_START(__ABORT_STACK_START)
    RUN_END(__ABORT_STACK_END)

    .undStack   : {. = . + __UND_STACK_SIZE;} align(4)      > DDR_MCU4_0  (HIGH)
    RUN_START(__UND_STACK_START)
    RUN_END(__UND_STACK_END)

    .svcStack   : {. = . + __SVC_STACK_SIZE;} align(4)      > DDR_MCU4_0  (HIGH)
