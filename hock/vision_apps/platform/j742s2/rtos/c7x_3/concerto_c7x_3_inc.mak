ifeq ($(RTOS),SYSBIOS)
	...
	XDC_CFG_FILE = $($(_MODULE)_SDIR)/c7x_3.cfg
...
ifeq ($(RTOS),SAFERTOS)
	...
	IDIRS+=${SAFERTOS_KERNEL_INSTALL_PATH_c7x}/source_code_and_projects/demo_projects/SafeRTOS_TDA4VH_C7x_Demo/TI_c7x_Support
	IDIRS+=${SAFERTOS_KERNEL_INSTALL_PATH_c7x}/source_code_and_projects/demo_projects/SafeRTOS_TDA4VH_C7x_Demo
endif

ifeq ($(RTOS),FREERTOS)
	LDIRS += $(PDK_PATH)/packages/ti/kernel/lib/$(SOC)/c7x_3/$(TARGET_BUILD)/
endif

ifeq ($(RTOS),SAFERTOS)
	LDIRS += $(PDK_PATH)/packages/ti/kernel/safertos/lib/$(SOC)/c7x_3/$(TARGET_BUILD)/
endif

LDIRS += $(PDK_PATH)/packages/ti/drv/ipc/lib/$(SOC)/c7x_3/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/drv/udma/lib/$(SOC)/c7x_3/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/drv/sciclient/lib/$(SOC)/c7x_3/$(TARGET_BUILD)/
...
# [Note]: no mma in c7x_3
# linking libraries to enable c7x_1 c7x_2 MMA loading on thermal_load_test
MMA_LIBS =
...
STATIC_LIBS += app_rtos_common_c7x_3
