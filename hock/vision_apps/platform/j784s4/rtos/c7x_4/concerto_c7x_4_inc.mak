ifeq ($(RTOS),SYSBIOS)
	...
	XDC_CFG_FILE = $($(_MODULE)_SDIR)/c7x_4.cfg
...
ifeq ($(RTOS),FREERTOS)
	LDIRS += $(PDK_PATH)/packages/ti/kernel/lib/$(SOC)/c7x_4/$(TARGET_BUILD)/
endif
...
LDIRS += $(PDK_PATH)/packages/ti/drv/ipc/lib/$(SOC)/c7x_4/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/drv/udma/lib/$(SOC)/c7x_4/$(TARGET_BUILD)/
LDIRS += $(PDK_PATH)/packages/ti/drv/sciclient/lib/$(SOC)/c7x_4/$(TARGET_BUILD)/
